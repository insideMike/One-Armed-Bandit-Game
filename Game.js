class Game{
  ...
  startGame(){
    ...
    if(!this.wallet.checkCanPlay(bid)){
      return alert('masz za mało pieniedzy')
    }
    ...
    this.stats.addGameToStat(win, bid)

    this.render(colors, this.wallet.getWalletValue(), win , this.stats.showGameStat(), bid, wonMoney)
  }
}
